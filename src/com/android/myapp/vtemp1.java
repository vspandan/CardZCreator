...
public class vtemp1 extends Activity{
	private AbsoluteLayout abs;
	 @Override
	    public void onCreate(Bundle savedInstanceState) {
	        ...
	        if(temp.equalsIgnoreCase("one"))
	        	setContentView(R.layout.vtemp1);
	        else if(temp.equalsIgnoreCase("two"))
	        	setContentView(R.layout.vtemp2);
	        else if(temp.equalsIgnoreCase("three"))
	        	setContentView(R.layout.vtemp3);
	        else if(temp.equalsIgnoreCase("four"))
	        	setContentView(R.layout.vtemp4);
	        else if(temp.equalsIgnoreCase("five"))
	        	setContentView(R.layout.vtemp5);
	        else if(temp.equalsIgnoreCase("six"))
	        	setContentView(R.layout.vtemp6);
	        else if(temp.equalsIgnoreCase("seven"))
	        	setContentView(R.layout.vtemp7);
	 ...
	 public boolean onOptionsItemSelected(MenuItem item) {
	     switch (item.getItemId()) {
	         case R.id.back:   
	        	 			final Dialog dialog = new Dialog(vtemp1.this);
	        	 			...
	        	 			LinearLayout l=new LinearLayout(vtemp1.this);
	        	 			l.setOrientation(LinearLayout.VERTICAL);
	        	 			TextView t1=new TextView(vtemp1.this);
	        	 			t1.setLayoutParams(params2);
	        	 			t1.setText("Sure? Any unsaved");
	        	 			l.addView(t1);
	        	 			TextView t2=new TextView(vtemp1.this);
	        	 			t2.setLayoutParams(params2);
	        	 			t2.setText("data will be lost ");
	        	 			l.addView(t2);
	        	 			final Button b1=new Button(vtemp1.this);
	        	 			...
	        	 			b1.setOnClickListener(new OnClickListener(){
	        	 				...
	        	 				{
	        	 					dialog.dismiss();
	        	 					startActivity(new Intent(vtemp1.this,vcard.class));
	        	 					finish();
	        	 				}
	        	 			});
	        	 			break;
	        	 			
	         case R.id.save:     final Dialog dialog3 = new Dialog(vtemp1.this);
        	...
        	LinearLayout l3=new LinearLayout(vtemp1.this);
        	l3.setOrientation(LinearLayout.VERTICAL);
        	final EditText q3=new EditText(vtemp1.this);
        	q3.setLayoutParams(params3);
        	l3.addView(q3);
        	final Button b3=new Button(vtemp1.this);
        	b3.setLayoutParams(params3);
        	b3.setText("Save as PNG");
        	l3.addView(b3);
        	final Button b4=new Button(vtemp1.this);
        				...
        				abs.draw(canvas);
                        	...
                        	catch(Exception e)
                        	{
                        		Log.i("exception",e.toString());
	                             ...
	                             break;
	         case R.id.help:     final Dialog dialog1 = new Dialog(vtemp1.this);
	 			...
	 			LinearLayout l1=new LinearLayout(vtemp1.this);
	 			l1.setOrientation(LinearLayout.VERTICAL);
	 			TextView t3=new TextView(vtemp1.this);
	 			t3.setLayoutParams(params);
	 			t3.setText("Sure? Any unsaved");
	 			l1.addView(t3);
	 			TextView t4=new TextView(vtemp1.this);
	 			t4.setLayoutParams(params);
	 			t4.setText("data will be lost ");
	 			l1.addView(t4);
	 			final Button b2=new Button(vtemp1.this);
	 			...
	 			b2.setOnClickListener(new OnClickListener(){
	 				...
	 				{
	 					dialog1.dismiss();
	 					startActivity(new Intent(vtemp1.this,help.class));
	 					finish();
	 				}
	 			});
	 			break;
